...
public class ValidationAop2 {
	...
	@Pointcut("@annotation(com.study.security_kyunghan.handler.aop.annotation.ValidCheck)")
	private void enableValid() {}
	
	@Before("enableValid()")
	public void ValiBefore(JoinPoint joinPoint) {
		...
		for(Object arg : args) {
			if(arg.getClass() == BeanPropertyBindingResult.class) {
				...
				if(bindingResult.hasErrors()) {
					...
					throw new CustomValidationApiExcetion("유효성 검사 실패", errorMap);
				}
			}
		}
	}
